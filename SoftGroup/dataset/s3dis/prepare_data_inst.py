...
def get_parser():
    ...
    parser.add_argument(
        '--data-root', type=str, default='/ssd1/softgroup/Stanford3dDataset_v1.2', help='root dir save data')
    parser.add_argument(
        '--save-dir', type=str, default='/ssd1/softgroup/preprocess', help='directory save processed data')
    parser.add_argument(
