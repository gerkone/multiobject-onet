...
def get_parser():
    ...
    parser.add_argument(
        '--data-dir', type=str, default='/ssd1/softgroup/preprocess', help='directory save processed data')
    parser.add_argument(
        '--save-dir', type=str, default='/ssd1/softgroup/val_gt', help='directory save ground truth')
