...
def get_args():
    ...
    parser.add_argument('--out', type=str, default='./outss', help='directory for output results')
...
def main():
    ...
    if is_main_process():
        ...
        if 'instance' in eval_tasks:
            ...
            print("pred_insts", pred_insts)
            np.save("./outsss/pred_insts.npy", pred_insts)
            np.save("./outsss/gt_insts.npy", gt_insts)
